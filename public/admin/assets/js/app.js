class App {
    ...
    initSidenav() {
        ...
        if (n) {
            n.querySelectorAll("li [data-bs-toggle='collapse']").forEach(
                (e) => {
...
class LayoutCustomizer {
    ...
    initSwitchListener() {
        var e = (e, t) => {
            ...
            e =
                (document
                    ...
                    .forEach((e) =>
                        e.addEventListener("click", () =>
                            this.changeSkin(e.getAttribute("data-skin"))
                        )
                    ),
                    e('input[name="data-sidenav-color"]', (e) =>
                        this.changeSidenavColor(e.value)
                    ),
                    ...
                    e('input[name="sidebar-user"]', (e) =>
                        this.changeSidenavUser(e.checked)
                    ),
        ...
        e &&
            ...
            document
                .querySelectorAll(".button-collapse-toggle")
                .forEach((e) => {
                    e.addEventListener("click", () => {
                        ...
                        "offcanvas" === e
                            ...
                            : this.changeSidenavSize(
                                { default: "collapse", collapse: "default" }[
                                e
                                ],
                                !0
                            );
    ...
    showBackdrop() {
        ...
        (a.id = "custom-backdrop"),
            ...
            (document.body.style.paddingRight =
                (((e = document.createElement("div")).style.visibility =
                    "hidden"),
...
class I18nManager {
    constructor({
        ...
        (this.selectedLanguage =
            sessionStorage.getItem("__SIMPLE_LANG__") || e),
            (this.langPath = t),
    ...
    setLanguage(e) {
        (this.selectedLanguage = e),
            localStorage.setItem("__SIMPLE_LANG__", e),
