    ...
    <div class="container-fluid topbar-menu">
        <div class="d-flex align-items-center justify-content-center gap-2">
            ...
            <div class="d-lg-none d-flex mx-1">
                <a href="index.html">
                    <img src="{{ asset('admin/assets/images/logo-sm.png') }}" height="28" alt="Logo">
                </a>
            </div>
                            ...
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <div class="p-3">
                                        ...
                                        <ul class="list-unstyled">
                                            <li><a href="javascript:void(0);" class="dropdown-item">My
                                                    Dashboard</a>
                                            </li>
                                            <li><a href="javascript:void(0);" class="dropdown-item">Recent
                                                    Activity</a>
                                            </li>
                                            <li><a href="javascript:void(0);" class="dropdown-item">Notifications
                                                    Center</a></li>
                                            <li><a href="javascript:void(0);" class="dropdown-item">File
                                                    Manager</a>
                                            </li>
                                            <li><a href="javascript:void(0);" class="dropdown-item">Calendar
                                                    View</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="p-3">
                                        ...
                                        <ul class="list-unstyled">
                                            <li><a href="javascript:void(0);" class="dropdown-item">Team
                                                    Overview</a>
                                            </li>
                                            <li><a href="javascript:void(0);" class="dropdown-item">Meeting
                                                    Schedule</a>
                                            </li>
                                            <li><a href="javascript:void(0);" class="dropdown-item">Timesheets</a></li>
                                            <li><a href="javascript:void(0);" class="dropdown-item">Feedback
                                                    Hub</a>
                                            </li>
                                ...
                                <div class="col-md-4">
                                    <div class="p-3">
                                        ...
                                        <ul class="list-unstyled">
                                            <li><a href="javascript:void(0);" class="dropdown-item">Profile
                                                    Settings</a>
                                            </li>
                                            <li><a href="javascript:void(0);" class="dropdown-item">Billing &
                                                    Plans</a>
                                            </li>
                                            ...
                                            <li><a href="javascript:void(0);" class="dropdown-item">Privacy &
                                                    Security</a></li>
                                            <li><a href="javascript:void(0);" class="dropdown-item">Support
                                                    Center</a>
                                            </li>
                                        </ul>
                                    </div> <!-- end dropdown-->
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="topbar-item me-2">
                <div class="dropdown" data-dropdown="custom">
                    <button class="topbar-link  fw-semibold" data-bs-toggle="dropdown" data-bs-offset="0,19"
                        ...
                        <img data-trigger-img src="{{ asset('admin/assets/images/themes/shadcn.svg') }}" alt="user-image"
                            class="w-100 rounded me-2" height="18">
            ...
            <div class="topbar-item">
                <div class="dropdown">
                    <button class="topbar-link fw-semibold" data-bs-toggle="dropdown" data-bs-offset="0,19"
                        type="button" aria-haspopup="false" aria-expanded="false">
                        <img src="{{ asset('admin/assets/images/flags/us.svg') }}" alt="user-image" class="w-100 rounded me-2" height="18"
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="en" title="English">
                            <img src="{{ asset('admin/assets/images/flags/us.svg') }}" alt="English" class="me-1 rounded" height="18"
                                data-translator-image>
                            <span class="align-middle">English</span>
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="de" title="German">
                            <img src="{{ asset('admin/assets/images/flags/de.svg') }}" alt="German" class="me-1 rounded" height="18"
                                data-translator-image>
                            <span class="align-middle">Deutsch</span>
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="it" title="Italian">
                            <img src="{{ asset('admin/assets/images/flags/it.svg') }}" alt="Italian" class="me-1 rounded" height="18"
                                data-translator-image>
                            <span class="align-middle">Italiano</span>
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="hi" title="Hindi">
                            <img src="{{ asset('admin/assets/images/flags/in.svg') }}" alt="Hindi" class="me-1 rounded" height="18"
                                data-translator-image>
                            <span class="align-middle">हिन्दी</span>
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="es" title="Spanish">
                            <img src="{{ asset('admin/assets/images/flags/es.svg') }}" alt="Spanish" class="me-1 rounded" height="18"
                                data-translator-image>
                            <span class="align-middle">Español</span>
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="ru" title="Russian">
                            <img src="{{ asset('admin/assets/images/flags/ru.svg') }}" alt="Russian" class="me-1 rounded" height="18"
                                data-translator-image>
                    ...
                    <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg">
                        ...
                        <div style="max-height: 300px;" data-simplebar>
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap active" id="message-1">
                                <span class="d-flex gap-2">
                                    <span class="flex-shrink-0">
                                        <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="avatar-md rounded-circle"
                                            alt="User Avatar">
                                    </span>
                                    <span class="flex-grow-1 text-muted">
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="message-2">
                                <span class="d-flex gap-2">
                                    <span class="flex-shrink-0">
                                        <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="avatar-md rounded-circle"
                                            alt="User Avatar">
                                    </span>
                                    <span class="flex-grow-1 text-muted">
            ...
            <div class="topbar-item nav-user">
                <div class="dropdown">
                    <a class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown"
                        ...
                        <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" width="32" class="rounded-circle d-flex"
                            alt="user-image">
                    </a>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- Header -->
