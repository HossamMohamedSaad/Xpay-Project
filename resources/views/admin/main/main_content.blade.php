                ...
                <div class="row justify-content-center py-5">
                    <div class="col-xxl-5 col-xl-7 text-center">
                        ...
                        <p class="fs-md text-muted mb-0">
                            A premium collection of elegant, accessible components and a powerful codebase. Built for
                            modern frameworks. Developer Friendly. Production Ready.
                        </p>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <div class="fw-semibold"><span data-target="1,110">1,110</span> <i
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xl-3 col-md-6 order-xl-last">
                                        <div class="text-center">
                                            ...
                                            <p class="mb-0 mt-4"><i data-lucide="clock"></i> Last accessed: 12.06.2025
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <h5 class="fs-base mb-0 fw-normal"><i
                                                            class="ti ti-circle-filled fs-xs"></i> Completed</h5>
                                                </td>
                                                <td style="width: 30px;">
                                                    <div class="dropdown">
                                                        <a href="#"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt=""
                                                            class="avatar-sm rounded-circle me-2">
                                                        <div>
                                                            <span class="text-muted fs-xs">David Lee</span>
                                                            <h5 class="fs-base mb-0"><a href="#!"
                                                                    class="text-body">#AI-5002</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td><span class="text-muted fs-xs">Status</span>
                                                    <h5 class="fs-base mb-0 fw-normal"><i
                                                            class="ti ti-circle-filled fs-xs"></i> Pending</h5>
                                                </td>
                                                <td style="width: 30px;">
                                                    <div class="dropdown">
                                                        <a href="#"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt=""
                                                            class="avatar-sm rounded-circle me-2">
                                                        <div>
                                                            <span class="text-muted fs-xs">Sophia Turner</span>
                                                            <h5 class="fs-base mb-0"><a href="#!"
                                                                    class="text-body">#AI-5003</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><span class="text-muted fs-xs">Model</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt=""
                                                            class="avatar-sm rounded-circle me-2">
                                                        <div>
                                                            <span class="text-muted fs-xs">James Wilson</span>
                                                            <h5 class="fs-base mb-0"><a href="#!"
                                                                    class="text-body">#AI-5004</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><span class="text-muted fs-xs">Model</span>
                                                ...
                                                <td><span class="text-muted fs-xs">Status</span>
                                                    <h5 class="fs-base mb-0 fw-normal"><i
                                                            class="ti ti-circle-filled fs-xs text-danger"></i> Failed
                                                    </h5>
                                                </td>
                                                <td style="width: 30px;">
                                                    <div class="dropdown">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt=""
                                                            class="avatar-sm rounded-circle me-2">
                                                        <div>
                                                            <span class="text-muted fs-xs">Ava Carter</span>
                                                            <h5 class="fs-base mb-0"><a href="#!"
                                                                    class="text-body">#AI-5005</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><span class="text-muted fs-xs">Model</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt=""
                                                            class="avatar-sm rounded-circle me-2">
                                                        <div>
                                                            <span class="text-muted fs-xs">Ethan Brooks</span>
                                                            <h5 class="fs-base mb-0"><a href="#!"
                                                                    class="text-body">#AI-5006</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><span class="text-muted fs-xs">Model</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt=""
                                                            class="avatar-sm rounded-circle me-2">
                                                        <div>
                                                            <span class="text-muted fs-xs">Mia Clarke</span>
                                                            <h5 class="fs-base mb-0"><a href="#!"
                                                                    class="text-body">#AI-5007</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><span class="text-muted fs-xs">Model</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt=""
                                                            class="avatar-sm rounded-circle me-2">
                                                        <div>
                                                            <span class="text-muted fs-xs">Lucas Perry</span>
                                                            <h5 class="fs-base mb-0"><a href="#!"
                                                                    class="text-body">#AI-5008</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><span class="text-muted fs-xs">Model</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt=""
                                                            class="avatar-sm rounded-circle me-2">
                                                        <div>
                                                            <span class="text-muted fs-xs">Chloe Adams</span>
                                                            <h5 class="fs-base mb-0"><a href="#!"
                                                                    class="text-body">#AI-5009</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><span class="text-muted fs-xs">Model</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt=""
                                                            class="avatar-sm rounded-circle me-2">
                                                        <div>
                                                            <span class="text-muted fs-xs">Benjamin Gray</span>
                                                            <h5 class="fs-base mb-0"><a href="#!"
                                                                    class="text-body">#AI-5010</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><span class="text-muted fs-xs">Model</span>
                            ...
                            <div class="card-footer border-0">
                                <div class="align-items-center justify-content-between row text-center text-sm-start">
                                    ...
                                    <div class="col-sm-auto mt-3 mt-sm-0">
                                        <ul
                                            class="pagination pagination-sm pagination-boxed mb-0 justify-content-center">
