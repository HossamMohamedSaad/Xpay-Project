                            ...
                            <div class="inner-content">
                                <div class="action__body w-full mb-40">
                                    ...
                                    <div class="flat-button flex">
                                        ...
                                        <a href="{{ route('client.account.add') }}" class="tf-button style-2 h50 w190 mr-10">Add New Account<i
                                                    ...
                                                    <div class="swiper-wrapper">
                                                            ...
                                                            <div class="tf-card-box style-4">
                                                                <div class="author flex items-center">
                                                                    ...
                                                                    <div class="info">
                                                                        ...
                                                                        <h6><a href="author-2.html">Marvin McKinney</a>
                                                                        </h6>
                                                                    </div>
                                                                </div>
                                                                <div class="card-media">
                                                                    <a href="#">
                                                                        <img src="assets/images/box-item/card-item-49.jpg"
                                                                            alt="">
                                                                    </a>
                                                                    <span class="wishlist-button icon-heart"></span>
                                                                </div>
                                                                <h5 class="name"><a href="nft-detail-2.html">Dayco
                                                                        serpentine belt</a></h5>
                                                                <div
                                                                    class="meta-info flex items-center justify-between">
                                                                    <div>
                                                                        <span class="text-bid">Current Bid</span>
                                                                        <h6 class="price gem"><i
                                                                                class="icon-gem"></i>0,34</h6>
                                                                    </div>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="tf-card-box style-4">
                                                                ...
                                                                <div class="card-media">
                                                                    <a href="#">
                                                                        <img src="assets/images/box-item/card-item-50.jpg"
                                                                            alt="">
                                                                    </a>
                                                                    <span class="wishlist-button icon-heart"></span>
                                                                </div>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="tf-card-box style-4">
                                                                ...
                                                                <div class="card-media">
                                                                    <a href="#">
                                                                        <img src="assets/images/box-item/card-item-51.jpg"
                                                                            alt="">
                                                                    </a>
                                                                    <span class="wishlist-button icon-heart"></span>
                                                                </div>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="tf-card-box style-4">
                                                                ...
                                                                <div class="card-media">
                                                                    <a href="#">
                                                                        <img src="assets/images/box-item/card-item-52.jpg"
                                                                            alt="">
                                                                    </a>
                                                                    <span class="wishlist-button icon-heart"></span>
                                                                </div>
