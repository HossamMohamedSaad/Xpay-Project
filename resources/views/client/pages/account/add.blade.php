        ...
        <div id="page" class="market-page">
            ...
            <div class="flat-tabs">
                ...
                <div class="content-tabs">
                    ...
                    <div id="account" class="tabcontent {{ Route::currentRouteName() == 'client.account.add' ? 'active' : '' }}">
                            ...
                            <div class="inner-content">
                                ...
                                <div class="widget-edit mb-30 profile">
                                    ...
                                    <form   id="commentform" class="comment-form" novalidate="novalidate"
                                            method="post" action="{{ route('client.account.create') }}">
                                        @csrf
                                        @method('POST')
                                        <div class="flex gap30">
                                            <fieldset class="name">
                                                <label>Account name</label>
                                                <input type="text" id="name" placeholder="Enter your Account name" name="name" tabindex="2" value="" aria-required="true" required>
                                            </fieldset>
                                            <fieldset class="email">
                                                <label>Account balance</label>
                                                <input type="text" id="email" placeholder="Your Account balance" name="amount" tabindex="2" value="" aria-required="true" required>
                                            </fieldset>
