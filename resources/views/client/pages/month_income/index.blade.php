        ...
        <div id="page" class="market-page">
            ...
            <div class="flat-tabs">
                ...
                <div class="content-tabs">
                    ...
                    <div id="month_income" class="tabcontent {{ Route::currentRouteName() == 'client.month_income.index' ? 'active' : '' }}">
                            ...
                            <div class="inner-content">
                                <div class="action__body w-full mb-40">
                                    ...
                                    <div class="flat-button flex" style="flex-direction: row-reverse;">
                                        <a href="{{ route('client.month_income.add') }}"
                                ...
                                <div class="heading-section">
                                    <h2 class="tf-title pb-30" >Monthly Income Resource</h2>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div data-wow-delay="0s" class="wow fadeInUp col-12">
                                                <div class="product-item offers">
                                                    <h6><i class="icon-description"></i>Monthly Income Resource</h6>
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <div class="table-item">
                                                            <div class="column"><h6 class="price gem">{{ $source->income_source?->name }}</h6></div>
                                                            <div class="column">{{ $source->amount }}</div>
                                                            <div class="column">{{ $source->period }}</div>
                                                            <div class="column">
                                                                <a href="{{ route('client.month_income.pay', $source->id) }}" class="btn btn-warning">Get</a>
                                                                <a href="{{ route('client.month_income.edit', $source->id) }}" class="btn btn-primary">Edit</a>
                                                                <a href="{{ route('client.month_income.delete', $source->id) }}" class="btn btn-danger">Delete</a>
                                                            </div>
