        ...
        <div id="page" class="market-page">
            ...
            <div class="flat-tabs">
                ...
                <div class="content-tabs">
                    ...
                    <div id="month_expense" class="tabcontent {{ Route::currentRouteName() == 'client.month_income.pay' ? 'active' : '' }}">
                        <div class="wrapper-content">
                            <div class="inner-content">
                                
                                <div class="widget-edit mb-30 profile">
                                    <div class="title">
                                        <h4>Get Monthly Income</h4>
                                        <i class="icon-keyboard_arrow_up"></i>
                                    </div>
                                    <form   id="commentform" class="comment-form" novalidate="novalidate"
                                            method="post" action="{{ route('client.month_income.confirmGet') }}">
                                        @csrf
                                        @method('POST')
                                        <input type="hidden"   name="month_category_id" value="{{ $month_category->id }}" >
                                        <input type="hidden"   name="amount" value="{{ $amount }}" >
                                        <input type="hidden"   name="income_source_id" value="{{ $income_source_id }}" >
                                        ...
                                        <div class="btn-submit">
                                            <button class="w242" type="submit">Get</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
