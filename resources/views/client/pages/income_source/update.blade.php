        ...
        <div id="page" class="market-page">
            ...
            <div class="flat-tabs">
                ...
                <div class="content-tabs">
                    ...
                    <div id="income_source" class="tabcontent {{ Route::currentRouteName() == 'client.income_source.edit' ? 'active' : '' }}">
                        <div class="wrapper-content">
                            <div class="inner-content">
                                
                                <div class="widget-edit mb-30 profile">
                                    <div class="title">
                                        <h4>Update Income Source</h4>
                                        <i class="icon-keyboard_arrow_up"></i>
                                    </div>
                                    <form   id="commentform" class="comment-form" novalidate="novalidate"
                                            method="post" action="{{ route('client.income_source.update') }}">
                                        @csrf
                                        @method('POST')
