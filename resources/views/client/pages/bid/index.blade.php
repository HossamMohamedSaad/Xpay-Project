...
<body class="body dashboard1">
    ...
    <div id="wrapper">
        <div id="page" class="market-page">
            ...
            <div class="flat-tabs">
                ...
                <div class="content-tabs">
                    ...
                    <div id="bid" class="tabcontent {{ Route::currentRouteName() == 'client.bid.index' ? 'active' : '' }}">
                                            ...
                                            <div class="wrap-box-card">
                                                <div class="col-item">
                                                    <div class="tf-card-box style-1">
                                                        <div class="card-media">
                                                            <a href="#">
                                                                <img src="assets/images/box-item/card-item-01.jpg"
                                                                    alt="">
                                                            </a>
                                                                    ...
                                                                    <div aria-hidden="true" class="countdown__timer">
                                                                        <span class="countdown__item"
                                                                            style="display: none;"><span
                                                                                ...
                                                                                class="countdown__label">d</span></span><span
                                                                            class="countdown__item"><span
                                                                                class="countdown__value countdown__value--1 js-countdown__value--1">02</span><span
                                                                                class="countdown__label">h</span></span><span
                                                                            class="countdown__item"><span
                                                                                class="countdown__value countdown__value--2 js-countdown__value--2">04</span><span
                                                                                class="countdown__label">m</span></span><span
                                                                            class="countdown__item"><span
                                                                                class="countdown__value countdown__value--3 js-countdown__value--3">55</span><span
                                                                                class="countdown__label">s</span></span>
                                                                    </div>
                                                                </span>
                                                            </div>
                                                ...
                                                <div class="col-item">
                                                    <div class="tf-card-box style-1">
                                                        <div class="card-media">
                                                            <a href="#">
                                                                <img src="assets/images/box-item/card-item-02.jpg"
                                                                    alt="">
                                                            </a>
                                                            <span class="wishlist-button icon-heart"></span>
                                                            <div class="featured-countdown">
                                                ...
                                                <div class="col-item">
                                                    <div class="tf-card-box style-1">
                                                        <div class="card-media">
                                                            <a href="#">
                                                                <img src="assets/images/box-item/card-item-03.jpg"
                                                                    alt="">
                                                            </a>
                                                            <span class="wishlist-button icon-heart"></span>
                                                            <div class="featured-countdown">
                                                ...
                                                <div class="col-item">
                                                    <div class="tf-card-box style-1">
                                                        <div class="card-media">
                                                            <a href="#">
                                                                <img src="assets/images/box-item/card-item-04.jpg"
                                                                    alt="">
                                                            </a>
                                                            <span class="wishlist-button icon-heart"></span>
                                                            <div class="featured-countdown">
        ...
        <!-- Modal Popup Bid -->
        @include('client.pages.bid.modalpopup')
