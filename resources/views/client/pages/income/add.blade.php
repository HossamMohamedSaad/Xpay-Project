        ...
        <div id="page" class="market-page">
            ...
            <div class="flat-tabs">
                ...
                <div class="content-tabs">
                    ...
                    <div id="income" class="tabcontent {{ Route::currentRouteName() == 'client.income.add' ? 'active' : '' }}">
                            ...
                            <div class="inner-content">
                                ...
                                <div class="widget-edit mb-30 profile">
                                    ...
                                    <form   id="commentform" class="comment-form" novalidate="novalidate"
                                            method="post" action="{{ route('client.income.create') }}">
                                        @csrf
                                        @method('POST')
                                        <div class="flex gap30">
                                            <fieldset class="curency">
                                                <label>Income Source</label>
                                                @if ($income_sources == null || $income_sources->isEmpty() )
