        ...
        <div id="page" class="market-page">
            ...
            <div class="flat-tabs">
                ...
                <div class="content-tabs">
                    ...
                    <div id="expense_category" class="tabcontent {{ Route::currentRouteName() == 'client.expense_category.add' ? 'active' : '' }}">
                            ...
                            <div class="inner-content">
                                ...
                                <div class="widget-edit mb-30 profile">
                                    ...
                                    <form   id="commentform" class="comment-form" novalidate="novalidate"
                                            method="post" action="{{ route('client.expense_category.create') }}">
                                        @csrf
                                        @method('POST')
                                        <div class="flex gap30">
                                            <fieldset class="name">
                                                <label> Name</label>
                                                <input type="text" id="name" placeholder="Enter your Source Name" name="name" tabindex="2" value="" aria-required="true" required>
                                            </fieldset>
                                            <fieldset class="description">
                                                <label>Description </label>
                                                <input type="text" id="description" placeholder="Your  Source Description  " name="description" tabindex="2" value="" aria-required="true" required>
                                            </fieldset>
