        ...
        <div id="page" class="market-page">
            ...
            <div class="flat-tabs">
                ...
                <div class="content-tabs">
                    ...
                    <div id="expense_category" class="tabcontent {{ Route::currentRouteName() == 'client.expense_category.index' ? 'active' : '' }}">
                        <div class="wrapper-content">
                            <div class="inner-content">
                                ...
                                <div class="heading-section">
                                    <h2 class="tf-title pb-30">Expense Category</h2>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div data-wow-delay="0s" class="wow fadeInUp col-12">
                                                <div class="product-item offers">
                                                    <h6><i class="icon-description"></i>Expense Category</h6>
