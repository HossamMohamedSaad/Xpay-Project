    ...
    <div class="over-content">
        <div class="content">
            ...
            <ul class="menu-tab">
                ...
                <li class="tablinks {{ Route::currentRouteName() == 'client.bid.index' ? 'active' : ''}}" data-tabs="bid">
                    <a href="{{ route('client.bid.index') }}">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.2">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <li class="tablinks {{ Route::currentRouteName() == 'client.explore.index' ? 'active' : ''}}" data-tabs="explore">
