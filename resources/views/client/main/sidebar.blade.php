<div class="section-menu-left">
    <div class="box-logo">
        <a href="index-2.html"><img src="{{ asset('client/assets/images/logo/logo.png') }}" alt=""></a>
    </div>
    ...
    <div class="over-content">
        ...
        <div class="content mt-30">
            <h6>Account</h6>
            <ul class="menu-tab">
                <li class="tablinks {{ Route::currentRouteName() == 'client.collection.index' ? 'active' : ''}}" data-tabs="tf-collection">
                    <a href="{{ route('client.collection.index') }}">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.2">
