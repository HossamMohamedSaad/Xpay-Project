<div class="section-menu-left">
    <div class="box-logo">
        <a href="{{ route('client.dashboard.index') }}"><img src="{{ asset('client/assets/images/logo/logo.png') }}" alt=""></a>
    </div>
    <div class="create menu-tab">
        <a href="{{ route('client.dashboard.index') }}" class="tf-button style-1 type-1 tablinks" data-tabs="create">
            <span>Dashboard</span>
    ...
    <div class="over-content">
        <div class="content">
            <h6>Money follow</h6>
            <ul class="menu-tab">
                <li class="tablinks {{ Route::currentRouteName() == 'client.income.index'?'active':'' }}" data-tabs="income">
                     <a href="{{ route('client.income.index') }}">
                ...
                <li class="tablinks {{ Route::currentRouteName() == 'client.expense.index'?'active':'' }}" data-tabs="expense">
                     <a href="{{ route('client.expense.index') }}">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.2">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            fill="white" />
                            <mask id="mask0_1075_5813" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="1"
                                y="2" width="20" height="19">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M1.83398 2.75H20.7527V20.3252H1.83398V2.75Z" fill="white" />
                            </mask>
        ...
        <div class="content">
            <h6>Account</h6>
            <ul class="menu-tab">
                <li class="tablinks {{ Route::currentRouteName() == 'client.account.index'?'active':'' }}" data-tabs="account">
                ...
                <li class="tablinks {{ Route::currentRouteName() == 'client.transaction.index'?'active':'' }}" data-tabs="transaction">
        ...
        <div class="content">
            ...
            <ul class="menu-tab">
                ...
                <li class="tablinks {{ Route::currentRouteName() == 'client.income_source.index' ? 'active' : ''}}" data-tabs="bid">
                    <a href="{{ route('client.income_source.index') }}">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.2">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                fill="white" />
                            <mask id="mask0_1075_3648" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="15"
                                y="1" width="6" height="6">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M15.8555 1.83344H20.7541V6.73293H15.8555V1.83344Z" fill="white" />
                            </mask>
                            ...
                            <mask id="mask1_1075_3648" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="1"
                                y="2" width="20" height="19">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M1.83398 2.60526H20.0407V20.8112H1.83398V2.60526Z" fill="white" />
                            </mask>
                ...
                <li class="tablinks {{ Route::currentRouteName() == 'client.expense_category.index' ? 'active' : ''}}" data-tabs="explore">
                    <a href="{{ route('client.expense_category.index') }}">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.2">
                            <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <div class="content">
            <h6>Monthly Category</h6>
            <ul class="menu-tab">
                <li class="tablinks {{ Route::currentRouteName() == 'client.month_income.index'?'active':'' }}" data-tabs="account">
                     <a href="{{ route('client.month_income.index') }}">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.2">
                            <path d="M6.75731 9.35159V15.64" stroke="white" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                ...
                <li class="tablinks {{ Route::currentRouteName() == 'client.month_expense.index' ? 'active' : ''}}" data-tabs="bid">
                    <a href="{{ route('client.month_expense.index') }}">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.2">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M6.61499 14.6693C6.46832 14.6693 6.32074 14.6226 6.19607 14.5272C5.89541 14.2953 5.83857 13.8636 6.07049 13.5629L8.81407 9.99708C8.92591 9.85133 9.09182 9.75691 9.27332 9.73399C9.45849 9.71016 9.63999 9.76149 9.78391 9.87608L12.3689 11.9065L14.6303 8.98874C14.8632 8.68716 15.294 8.63124 15.5947 8.86591C15.8953 9.09874 15.9503 9.53049 15.7175 9.83024L13.0317 13.2952C12.9198 13.4401 12.7548 13.5345 12.5733 13.5565C12.39 13.5812 12.2085 13.5281 12.0637 13.4153L9.48049 11.3858L7.16041 14.4007C7.02474 14.5767 6.82124 14.6693 6.61499 14.6693Z"
        ...
        <div class="content mt-30">
            <h6>Account</h6>
            <ul class="menu-tab">
                <li class="tablinks {{ Route::currentRouteName() == 'client.plan.index' ? 'active' : ''}}" data-tabs="tf-collection">
                    <a href="{{ route('client.plan.index') }}">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.2">
                            <mask id="mask0_1075_14628" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="1"
                                y="1" width="20" height="20">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M1.83398 1.83334H20.8059V20.7798H1.83398V1.83334Z" fill="white" />
                            </mask>
                ...
                <li class="tablinks {{ Route::currentRouteName() == 'client.subscription.index' ? 'active' : ''}}" data-tabs="tf-collection">
                ...
                <li class="tablinks {{ Route::currentRouteName() == 'client.report.index' ? 'active' : ''}}" data-tabs="tf-collection">
                ...
                {{-- <li class="tablinks {{ Route::currentRouteName() == 'client.favorite.index' ? 'active' : ''}}" data-tabs="favorite">
                    <a href="{{ route('client.favorite.index') }}">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.2">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M14.668 6.14166C15.6488 6.45883 16.3418 7.33425 16.4252 8.36183" stroke="white"
                ...
                <li class="tablinks {{ Route::currentRouteName() == 'client.wallet.index' ? 'active' : ''}} " data-tabs="wallet">
                ...
                <li class="tablinks {{ Route::currentRouteName() == 'client.history.index' ? 'active' : ''}} " data-tabs="history">
                ...
                <li class="tablinks {{ Route::currentRouteName() == 'client.setting.index' ? 'active' : ''}}" data-tabs="settings">
                    ...
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.2">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <ellipse cx="11.1587" cy="10.8983" rx="2.41648" ry="2.41648" stroke="white"
                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </g>
                    </svg>
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <form method="POST" action="{{ route('client.logout') }}" id="form_logout">@csrf<a href="javascript:{}" onclick="document.getElementById('form_logout').submit();">Logout</a></form>
                    ...
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.2">
                            <path
                                ...
                                stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M19.9907 11.0196H8.95312" stroke="white" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M17.3047 8.34741L19.9887 11.0195L17.3047 13.6925" stroke="white" stroke-width="1.5"
