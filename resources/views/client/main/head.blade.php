                            ...
                            <div class="avatar_popup2">
                                <div class="">
                                    <div class="links">
                                        ...
                                        <form method="POST" action="{{ route('client.logout') }}" id="logout">
                                            @csrf   
                                            <a href="javascript:{}" onclick="document.getElementById('logout').submit();"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
